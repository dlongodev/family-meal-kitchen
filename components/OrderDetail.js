  ...
  return (
    <>
      <FlexDiv flex="column" m="0">
        <FormTitle>Contact & Delivery Details</FormTitle>
        ...
        <Form onSubmit={handleSubmit}>
          ...
          <FormGroup>
            ...
            <fieldset>
              ...
              <Input
                ...
                id="cityStateZip"
                name="cityStateZip"
                placeholder="Hobe Sound, FL 33455"
                type="text"
                onChange={(e) =>
                  setFormData({ ...formData, cityStateZip: e.target.value })
                }
              />
            </fieldset>
          </FormGroup>
          <FormGroup>
            <fieldset>
              ...
              <Input
                ...
                type="date"
                onChange={(e) =>
                  setFormData({ ...formData, deliveryDate: moment(e.target.value).format("l") })
                }
              />
            </fieldset>
            <fieldset>
              ...
              <Input
                ...
                type="time"
                onChange={(e) =>
                  setFormData({...formData, deliveryTime: moment(e.target.value, "HH:mm").format("h:mm A")})
                }
              />
            </fieldset>
          </FormGroup>
          ...
          <FlexDiv justify="space-between">
            <ButtonSolid m="1rem 0 0 0" w="inherit" type="submit">
              Place Order
            </ButtonSolid>
            <Link href="/menu" passHref>
              <BtnLinkOutlined m="1rem 0 0 0" w="inherit">
                Add More Items
              </BtnLinkOutlined>
            </Link>
          </FlexDiv>
